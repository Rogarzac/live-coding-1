...
var string = "árbol";
var myArray = ["balon", "ventana", "cama", "tele","computadora"];
console.log(myArray);




function bigWords(string, myArray){
var longitud = myArray.;
console.log(longitud);
return value
}
*/
//Hasta aqui llegue yo Angel me hizo la retroalimentacion de que necesito practicar mucho los metodos, realmente tiene razon, al mmomento de programar sin recursos si se me cierra el mundo, posteirormente, apoyado con el, pudimos completar el ejercicio:
